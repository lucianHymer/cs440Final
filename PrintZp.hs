...
instance Print Decl where
  prt i e = case e of
    Dec type_ ids -> prPrec i 0 (concatD [prt 0 type_, prt 0 ids])
  prtList _ [] = (concatD [])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ","), prt 0 xs])
instance Print Stm where
  prt i e = case e of
    ...
    SRepeat stm exp -> prPrec i 0 (concatD [doc (showString "repeat"), prt 0 stm, doc (showString "until"), doc (showString "("), prt 0 exp, doc (showString ")")])
    SIf exp stm -> prPrec i 0 (concatD [doc (showString "if"), doc (showString "("), prt 0 exp, doc (showString ")"), prt 0 stm])
    SIfThenElse exp stm1 stm2 -> prPrec i 0 (concatD [doc (showString "if"), doc (showString "("), prt 0 exp, doc (showString ")"), doc (showString "then"), prt 0 stm1, doc (showString "else"), prt 0 stm2])
    SIfThen exp stm -> prPrec i 0 (concatD [doc (showString "if"), doc (showString "("), prt 0 exp, doc (showString ")"), doc (showString "then"), prt 0 stm])
    SFor exp1 exp2 exp3 stm -> prPrec i 0 (concatD [doc (showString "for"), doc (showString "("), prt 0 exp1, doc (showString ";"), prt 0 exp2, doc (showString ";"), prt 0 exp3, doc (showString ")"), prt 0 stm])
...
instance Print Exp where
  prt i e = case e of
    ...
    ELt exp1 exp2 -> prPrec i 1 (concatD [prt 2 exp1, doc (showString "<"), prt 2 exp2])
    EGt exp1 exp2 -> prPrec i 1 (concatD [prt 2 exp1, doc (showString ">"), prt 2 exp2])
