...
// Return type string given type_t ID
...
// Check that expected arguments match given
...
// Check that expected return value matches given
...
// Add function type infor to bare function declared before
